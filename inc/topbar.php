                    ...
                    <ul class="list-unstyled topbar-right-menu float-right mb-0">
                        ...
                        <li class="dropdown notification-list">
                            ...
                            <div class="dropdown-menu dropdown-menu-right dropdown-menu-animated profile-dropdown">
                                ...
                                <!-- item-->
                                <a href="javascript:void(0);" class="dropdown-item notify-item">
                                    <i class="fi-help"></i> <span>Dukung Kami</span>
                                </a>
                                <!-- item-->
                                <a href="javascript:void(0);" class="dropdown-item notify-item">
                                    <i class="fi-lock"></i> <span>Kunci Layar</span>
                                </a>
                                <!-- item-->
                                <a href="backend/logout.php" class="dropdown-item notify-item">
                                    <i class="fi-power"></i> <span>Kleuar</span>
                                </a>
                            </div>
                        </li>
                    </ul>
                    <ul class="list-inline menu-left mb-0">
                        ...
                        <li>
                            <div class="page-title-box">
                                ...
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item active">Selamat datang di dashboard <?= $_SESSION['name'] ?>!</li>
                                </ol>
                            </div>
                        </li>
                    </ul>
