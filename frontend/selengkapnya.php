<?php 
    ...
    $id = $_GET['id'];
    $select = "SELECT * FROM selengkapnya where id='$id'";
                                ...
                                <nav class="navbar navbar-expand-lg">
                                    ...
                                    <div class="collapse navbar-collapse" id="navbarNav">
                                        <ul class="navbar-nav ml-auto">
                                            ...
                                            <li class="nav-item"><a class="nav-link" href="#quality">Kualitas</a></li>
                                    ...
                                    <ul>
                                        <li>
                                            ...
                                            <div class="post-avatar-content">
                                                ...
                                                <p>Jika ingin Desain Rumah Yang Nyaman, Modern & Tidak Ribet ?
                                                    Hubungi Kami
                                                </p>
                    ...
                    <div class="row align-items-center">
                        <div class="col-12">
                            <div class="copyright-text text-center">
                                <p>Copyright© <span>RD Design</span> | Semua Hak Dilindungi Undang-Undang</p>
                            </div>
                        </div>
                    </div>
                </div>
