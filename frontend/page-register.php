...
<head>
    <meta charset="utf-8" />
    <title>Renol Diaz Website Portfolio</title>
...
<body class="account-pages">
    ...
    <div class="wrapper-page account-page-full">
                    ...
                    <div class="card-box p-5">
                        ...
                        <form class="form-horizontal" action="../backend/register.php" method="post">
                            ...
                            <div class="form-group row m-b-20">
                                <div class="col-12">
                                    <div class="checkbox checkbox-custom">
                                        ...
                                        <label for="remember">
                                            Saya Terima <a href="#" class="" style="color:#9C06CC">Syarat & Ketentuan</a>
                                        </label>
                                    </div>
                                </div>
                                <!-- check error -->
                            ...
                            <div class="form-group row text-center m-t-10">
                                <div class="col-12">
                                    <button class="btn btn-block btn-custom waves-effect waves-light" type="submit" style="background: #A300BD; border:#A300BD">Daftar Gratis</button>
                                </div>
                            </div>
                        </form>
                        <div class="row m-t-50" style="">
                            <div class="col-sm-12 text-center">
                                <p class="text-muted">Sudah mempunyai akun? <a href="page-login.php" class="text-dark m-l-5"><b>Masuk</b></a></p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="m-t-60 text-center" style="position: relative;">
            <p class="account-copyright"><?php echo date('Y')?>-@copyright Oleh Ones Bhogar</p>
        </div>
    </div>
