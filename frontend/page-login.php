    ...
    <body class="account-pages">
        ...
        <div class="wrapper-page account-page-full">
                        ...
                        <div class="card-box p-5">
                            <h2 class="text-uppercase text-center pb-4">
                                <a href="index.html" class="text-success">
                                    <span><img src="../assets/images/green_logo.png" alt="" height="45"></span>
                                </a>
                            </h2>
                                    <?php 
                            ...
                            <form class="" action="../backend/login.php" method="post">
                                ...
                                <div class="form-group row m-b-20">
                                    <div class="col-12">
                                        <a href="page-recoverpw.html" class="text-muted float-right"><small>Lupa Password Anda?</small></a>
                            ...
                            <div class="row m-t-50">
                                <div class="col-sm-12 text-center">
                                    <p class="text-muted">Tidak mempunyai akun? <a href="page-register.php" class="text-dark m-l-5"><b>Daftar</b></a></p>
                                </div>
                            </div>
            ...
            <div class="m-t-40 text-center">
                <p class="account-copyright"><?php echo date('Y') ?> © ONES BHOGAR</p>
            </div>
