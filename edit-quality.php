<?php include 'inc/header.php';
    ...
    $id = $_GET['id'];
    $sel = "SELECT * FROM quality  WHERE id='$id'";
                            ...
                            <div class="card-box">
                                <div class="jumbotron text-center">
                                 ...
                                 <?php 
                                     ...
                                     ?>
                                   <form action="backend/edit-quality-add.php" method="post" enctype="multipart/form-data">
                                ...
                                <!-- Title 1 error showing -->
                                  ...
                                  <div class="form-group">
                                      ...
                                      <img src="img/quality/<?= $value['img']?>" alt="img" width="150px"height="150px">
                                      <?php 
